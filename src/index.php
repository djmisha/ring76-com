    ...
    <section id="contact" class="contact-section">
        <div class="container">
            ...
            <div class="form-container">
                <form id="contact-form" class="contact-form" method="post" action="process-form.php">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" placeholder="Tell us about your interests in magic" rows="4"></textarea>
                    </div>
