...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // Validate message
            hasError = validateField(messageInput, messageError, validateMessage) || hasError;
        ...
        // Removed initial validation on page load
        // Now validation only happens on submit or after user interaction
    }
});
